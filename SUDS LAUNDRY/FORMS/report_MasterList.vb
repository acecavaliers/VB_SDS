...
Public Class report_MasterList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SUDS_LAUNDRY.report_MasterList.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_crTextBox() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedreport_MasterList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As report_MasterList = New report_MasterList()
        rpt.Site = Me.Site
        Return rpt
    End Function

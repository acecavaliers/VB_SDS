...
Public Class report_delivery
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SUDS_LAUNDRY.report_delivery.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreport_delivery
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As report_delivery = New report_delivery()
        rpt.Site = Me.Site
        Return rpt
    End Function

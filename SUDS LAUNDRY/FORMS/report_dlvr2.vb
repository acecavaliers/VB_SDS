...
Public Class report_dlvrrpt2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SUDS_LAUNDRY.report_dlvr.rpt2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreport_dlvrrpt2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As report_dlvrrpt2 = New report_dlvrrpt2()
        rpt.Site = Me.Site
        Return rpt
    End Function

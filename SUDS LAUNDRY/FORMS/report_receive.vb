...
Public Class report_receive
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SUDS_LAUNDRY.report_receive.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreport_receive
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As report_receive = New report_receive()
        rpt.Site = Me.Site
        Return rpt
    End Function
